# OS-9 v2.4 Error Codes — Fact Cards

**Document:** OS-9 v2.4 Technical Reference Manual  
**Scope:** Error Code Appendix (pilot extraction)  
**Architecture:** 68000 (verified; document is 68k-scoped)  
**Card count:** 80  
